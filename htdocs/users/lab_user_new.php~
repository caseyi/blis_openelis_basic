...
function add_lab_user()
{
	...
	var showpname = 0;
	//var cat_code12=$( "select[name='cat_code12[]']" ).attr("value");
	...
	*/
	...
	var data_string = 'u='+username+'&p='+pwd+'&fn='+fullname+'&em='+email+'&cat='+cat_code12+'&ph='+phone+'&ut='+ut+'&lid=<?php echo $lab_config_id; ?>&lang='+lang_id+"&showpname="+showpname;
