...
else
{
	...
	else if($attrib_type == 13)
	{
		...
		$query_string = "UPDATE test SET 
							...
							($new_comm!=$comm ? ",comments='".mysql_real_escape_string(str_replace($comm, $new_comm, $record['comments']))."'" : "").
                    		" WHERE test_id ='$attrib_value'";
	}
}
...
<table class="table tale-striped table-condensed" id="<?php echo $attrib_type; ?>"> <!-- class="tablesorter" -->
	<thead>
		...
		<tr>
			...
			?>
				<th style='width:100px;'><?php echo "Time Received";?></th>
			<?php
			if($_SESSION['pid'] != 0)
			{
			?>
