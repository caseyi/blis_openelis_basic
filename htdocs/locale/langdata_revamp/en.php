...
$LANG_ARRAY = array ( 
		...
		"ALL_REGISTERED_TESTS" => "All registered tests",
				...
				"KENYA" => "Kenya",
				"BLIS" => "OE Basic",
				"REASON_FOR_REJECTION" => "Reasons for Rejection",
				"ERR_MISSING_REASONS_FORREJECTION" => "Error: Missing reasons for rejection",
				"DOCTOR_NAME" => "Doctor name",
				"VIEW_DETAILS" => "View Details",
				"RECORDS_FOUND" => "record(s) found.",
				"VISIT_NUMBER" => "Visit Number",
				"TIPS_SPECIMENT_ADDED_1" => "This page allows us to view a summary of both patient and the specimens we registered.",
				"TIPS_SPECIMENT_ADDED_2" => "Once a specimen has been registered, we can use this page to get the specimen number for labelling of the specimen.",
				"SELECT_TESTS" => "Select Tests",
				"GENERATE_BILL" => "Generate Bill",
				"BACK" => "Back",
				"SPECIMEN_ACCPTED" => "Specimen Accepted",
				"TIME_REGISTERED" => "Time Registered",
				"SPECIMEN_TYPE" => "Specimen Type",
				//check with OD
				"VIEW_SPECIMEN_DETAILS" => "View specimen details",
				"START_TEST" => "Start test",
				"RESULT_FORM" => "Results form",
				"PATIENT_TEST_HISTORY" => "Patient Test history",
				"RESULT_INTERPRETATION" => "Result Interpretation",
				"TYPE_TO_ENTER_RESULT" => "Type to enter results",
				"READ_RESULT" => "Read results",
				"CMD_CLOSE" => "Close",
				"RETURNED" => "Returned",
				"REJECTED" => "Rejected",
				"REFERED" => "Referred",
				"VIEW_RESLUTS" => "View Results",
				"CLICK_ENTER_RESULTS_SPECIMEN" => "Click to Enter Results for this Specimen",
				"CLICK_VIEW_RESULTS" => "Click to view results",
				"CLICK_BEGIN_TEST_SPECIMEN" => "Click to begin testing this Specimen",
				"CLICK_VIEW_VERIFY_RESULTS_SPECIMEN" => "Click to view and verify results of this Specimen",
				"RESULT_NO_EMPTY" => "Result cannot be empty",
