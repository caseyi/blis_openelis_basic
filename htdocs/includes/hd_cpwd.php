...
# 
# ////
# This page is create on 25th Sept 2014 for the purpose of including it on the first_pwd_change.php
# using the normal header.php has challenges because the essence of first_pwd_change.php is to have users change their initial passwords before 
# ... begin to use the system.
# Future modification will require Dynamically blocking menus for the first_pwd_change.php page
# ///
#
